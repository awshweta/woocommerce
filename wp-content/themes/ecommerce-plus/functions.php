...
function ecommerce_plus_general_admin_notice(){
         ...
         $msg = sprintf('<div data-dismissible="disable-done-notice-forever" class="notice notice-info" >
				...
				<a href=%4$s style="text-decoration:none;" class="button button-primary" > %5$s </a>
				<span>%6$s</span>
				<a href="?ecommerce_plus_notice_dismissed" style="text-decoration: none; float: right;" >%7$s</a></p></div>',
				esc_html__('Get Most out of the theme','ecommerce-plus'),
				esc_url('https://www.ceylonthemes.com/product/wordpress-ecommerce-theme'),			
				esc_html__('Download Demo','ecommerce-plus'),				
				esc_url(home_url(). '/wp-admin/tools.php?page=advanced-import-tool'),			
				esc_html__('Install Demo with Advanced Import Plugin','ecommerce-plus'),
